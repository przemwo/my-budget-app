...
class AddSpendingFormIndex extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      <div className="form-inline">
        ...
        />
          ...
          <Button
            ...
            handleOnClick={this.onClickaddSpendingButton}
            type="btn-primary"
          >
            Add
          </Button>
...
const AddSpendingForm = connect(mapStateToProps)(AddSpendingFormIndex);
